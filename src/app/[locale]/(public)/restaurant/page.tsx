          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href={`/${locale}/restaurant/menu`}>
                <Button size="lg" className="bg-orange-500 hover:bg-orange-600 text-white text-lg px-10 py-7 shadow-xl shadow-orange-500/30 border-0">
                  <Utensils className="h-6 w-6 mr-3" />
                  {locale === 'en' ? 'View Menu' : 'Voir le Menu'}
                </Button>
              </Link>
              <Button variant="outline" size="lg" className="border-2 border-white/40 text-white hover:bg-white/10 text-lg px-10 py-7 backdrop-blur-sm">
